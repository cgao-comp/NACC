...
def load_webKB(dataset_str, dice):
    edges_path = "C:/Users/Administrator/Desktop/GCN_MNCD/New_DGI/DGI/data_our/" + dataset_str + "/edges.txt"
    label_path = "C:/Users/Administrator/Desktop/GCN_MNCD/New_DGI/DGI/data_our/" + dataset_str + "/labels.txt"
    features_path = "C:/Users/Administrator/Desktop/GCN_MNCD/New_DGI/DGI/data_our/" + dataset_str + "/features.txt"
...
def normalize_adj(adj):
    """Symmetrically normalize adjacency matrix."""#对称标准化邻接矩阵
...
def get_adj_lilmatrix(edge_path, node_num):
    ...
    with open(edge_path, 'r') as fp:
        ...
        for line in content_list[0:]:
            ...
            # print("the from is:{0}, to is:{1}".format(line_list[0], line_list[1]))
...
def adj_Generate_new(edge_index, edge_logits, nodenum,drop_prob2):
...
def adj_Generate_new2(adj,dice,node_num):#
    ...
    similarities = getJaccard_similarity(node_num, g)
    adj_new = adj.detach().numpy() + dice * similarities
